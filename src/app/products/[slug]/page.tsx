 ...
 * Dynamic catch-all router replicating the exact premium visual layout
 * of standard single product pages. Loads details from DB or static JSON.
 */
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    async function loadProductDetail() {
      try {
        ...
        console.warn("Failed to query public products API, trying fallback:", err);
      }
      
      // Fallback
      const matchStatic = staticProducts.find((p: any) => p.slug === slug);
      if (matchStatic) {
        setProduct(matchStatic as any);
      }
      setLoading(false);
    }
  ...
  // Extract texts based on language selection
    ...
    <div className="bg-[#FAF9F5] font-arone text-black min-h-screen pb-20">
      ...
      <section className="py-12 px-6">
        <div className="mx-auto max-w-310">
          ...
          {/* 2. Main Top Intro Block - 2 Columns */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-16">
            ...
            {/* Right side: Core Parameters and Common Applications */}
          ...
          {/* 3. Technical Data Sheet Table Segment */}
          ...
          {/* 4. Accessories & Quality Assurance Section */}
          ...
          {/* 5. RFQ Call to Action Trigger Banner */}
          {ctaTitle && (
