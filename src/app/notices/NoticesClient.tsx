...
export default function NoticesClient({ initialNotices }: NoticesClientProps) {
  ...
  const filteredNotices = notices.filter((notice) => {
    const title = activeLang === "bn" ? notice.titleBn || notice.titleEn : notice.titleEn;
                ...
                <table className="w-full border-collapse text-left">
                  ...
                  <tbody>
                    {filteredNotices.map((notice, index) => {
                      ...
                      const displayTitle = activeLang === "bn" ? notice.titleBn || notice.titleEn : notice.titleEn;
                      const displayContent = activeLang === "bn" ? notice.contentBn || notice.contentEn : notice.contentEn;
                          ...
                          <td colSpan={4} className="p-0">
                            <table className="w-full border-collapse">
                              <tbody>
                                ...
                                >
                                  <td className="py-5 px-6 font-semibold text-neutral-500 text-center w-16">
                                    {index + 1}
                                  </td>
                                  ...
                                  <td className="py-5 px-6 font-medium text-neutral-600 whitespace-nowrap w-36">
                                    {formatLocalDate(notice.publishDate)}
                                  </td>
                                  <td className="py-5 px-6 w-44" onClick={(e) => e.stopPropagation()}>
                                    <div className="flex flex-col gap-1.5">
                  ...
                  <div>
                    ...
                    <div className="text-center mb-8">
                      <h3 className="font-kanit text-[18px] md:text-[20px] font-bold text-neutral-900 border-b border-double border-neutral-400 pb-3 max-w-xl mx-auto leading-snug">
                        {activeLang === "bn" ? previewNotice.titleBn || previewNotice.titleEn : previewNotice.titleEn}
                      </h3>
                    </div>
                    ...
                    <div className="text-[14px] md:text-[15px] leading-relaxed text-neutral-800 font-medium text-justify mb-10 whitespace-pre-line font-arone">
                      {activeLang === "bn" ? previewNotice.contentBn || previewNotice.contentEn : previewNotice.contentEn}
                    </div>
                  </div>
                    ...
                    <div className="text-right space-y-1 max-w-sm">
                      <div className="h-8 flex justify-end items-end pr-6 pointer-events-none select-none">
                        <span className="font-serif italic text-[18px] text-neutral-600 tracking-wide font-medium">
                          {activeLang === "bn" ? (previewNotice.signatoryBn || previewNotice.signatoryEn).slice(0, 10) : (previewNotice.signatoryEn).slice(0, 10)}...
                        </span>
                      </div>
                      <div className="h-[1.5px] w-48 bg-neutral-400 ml-auto" />

                      <h4 className="font-bold text-[14px] text-neutral-900 pt-1 leading-none">
                        {activeLang === "bn" ? previewNotice.signatoryBn || previewNotice.signatoryEn : previewNotice.signatoryEn}
                      </h4>
                      <p className="text-[12px] text-neutral-500 font-bold leading-none">
                        {activeLang === "bn" ? previewNotice.designationBn || previewNotice.designationEn : previewNotice.designationEn}
                      </p>
