 ...
 * Renders a visual list of field and workshop maintenance services
 * dynamically fetched from API, with support for translation and fallbacks.
 */
    ...
    async function loadData() {
      try {
        ...
        if (res.ok) {
          ...
          setItems(data.items || fallbackItems);
          setSettings(data.settings || fallbackSettings);
        } else {
